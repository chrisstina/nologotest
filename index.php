...
// можно вынеести в отдельный файл вроде bootstrap.php, при наличии дополнительных манипуляций перед загрузкой. Оставляю здесь, чтобы не плодить лишние файлы
